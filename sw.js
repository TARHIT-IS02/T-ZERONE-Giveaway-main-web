...
const SHELL_CACHE_NAME = "tzerone-shell-v3";

// The app shell files plus the same critical assets already <link rel="preload">-ed (or,
// for the Game tab banner, background-cached via preloadGameAssets()) in/around
// index.html's <head> and script.js (logo, hero image, the three mascot images, and the
// Game tab's CLASH BLADE banner). v2: added the CLASH BLADE banner so a repeat visit gets
// it from this offline shell cache too, not just the browser's own HTTP image cache.
const PRECACHE_URLS = [
    "./",
    "index.html",
    "styles.css",
    ...
    "https://raw.githubusercontent.com/TARHIT-T0SVX/All-image-t-z/refs/heads/main/Game/clash_blade_official_icon_T01.jpeg",
    "https://raw.githubusercontent.com/TARHIT-IS02/all-images/refs/heads/main/fav-icon-main-logo-round.png"
];
